...
PROMPT_V1_NAME = "nguyen-tien-huan-rag-prompt-v1"   # ví dụ: "nguyen-rag-v1"
PROMPT_V2_NAME = "nguyen-tien-huan-rag-prompt-v2"   # ví dụ: "nguyen-rag-v2"
...
SYSTEM_V1 = "Bạn là trợ lý AI thân thiện. \nTrả lời ngắn gọn, rõ ràng (2-4 câu) dựa trên context.\n\nContext:\n{context}"
...
SYSTEM_V2 = "Bạn là chuyên gia phân tích thông tin. Khi trả lời, hãy: \n1) Tóm tắt câu trả lời chính, \n2) Trích dẫn nguồn từ context, \n3) Nêu rõ mức độ chắc chắn của câu trả lời. Luôn dựa trên dữ liệu được cung cấp, không suy đoán thêm.\n\nContext:\n{context}"
